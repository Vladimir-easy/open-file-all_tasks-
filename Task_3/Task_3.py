...
name_1 = os.path.basename(r'C:\Users\easyv\OneDrive\Рабочий стол\Открытие и чтение ДЗ\Task_3\1.txt')
file_2 = open("2.txt", encoding="utf-8")
name_2 = os.path.basename(r'C:\Users\easyv\OneDrive\Рабочий стол\Открытие и чтение ДЗ\Task_3\2.txt')
file_3 = open("3.txt", encoding="utf-8")
name_3 = os.path.basename(r'C:\Users\easyv\OneDrive\Рабочий стол\Открытие и чтение ДЗ\Task_3\3.txt')
